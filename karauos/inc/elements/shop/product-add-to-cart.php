...
class TMT_Product_Add_To_Cart extends Widget_Base {

	public function get_name() {
		return 'tmt-product-add-to-cart';
	}

	public function get_title() {
		return __( 'Add To Cart', text_domain );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Select field', text_domain ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
	...
	protected function render() {
		...
		<div class="tmt-product-add-to-cart flex flex-column align-items-<?php echo $alignment; ?> elementor-product-<?php echo esc_attr( wc_get_product()->get_type() ); ?>">
...
Plugin::instance()->widgets_manager->register_widget_type( new TMT_Product_Add_To_Cart );