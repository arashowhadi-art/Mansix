...
class TMT_Product_Data_Tabs extends Widget_Base {

	public function get_name() {
		return 'tmt-product-data-tabs';
	}

	public function get_title() {
		return __( 'Product Data Tabs', text_domain );
	}
...
Plugin::instance()->widgets_manager->register_widget_type( new TMT_Product_Data_Tabs );