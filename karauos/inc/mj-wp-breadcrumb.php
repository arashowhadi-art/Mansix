<?php
    ...
    if ( ! function_exists( 'mj_wp_breadcrumb' ) ) {
        function mj_wp_breadcrumb ( $list_style = 'ol', $list_id = 'breadcrumb', $list_class = 'breadcrumb flex', $active_class = 'active', $echo = false ) {
            // Get text domain for translations
            $theme = wp_get_theme();
            $text_domain =  $theme->get( text_domain );
            ...
            if ( is_front_page() ) {
                ...
                $breadcrumb .= '<li><a href="' . home_url() . '">' . '<i class="fas fa-home"></i>' . '</a></li>';
            }
